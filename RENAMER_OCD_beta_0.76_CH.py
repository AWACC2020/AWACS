...
file_suffix_checkbox = ix.api.GuiCheckbox(panel_3,10,220,"文件后缀名")
object_type_suffix_checkbox = ix.api.GuiCheckbox(panel_3,10,245,"物体类型后缀")
Filereader_Renamer_Button = ix.api.GuiPushButton(panel_3,150,230,160,25,"重命名文件读取类物体")
#panel_4 combiner_group_Renamer
combiner_group_object_type_suffix_checkbox = ix.api.GuiCheckbox(panel_4,10,285,"物体类型后缀")
combiner_group_Renamer_Button = ix.api.GuiPushButton(panel_4,150,280,160,25,"重命名Combiner/Group")
#connect command
